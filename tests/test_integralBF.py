...
from nupot.integrals.integralBF import FunctionBF, IntegralBF
...
def test_eval_integralBF_1(n_num, r_2_num):
    ...
    a, r = sp.symbols("a r")
    n = sp.Rational(n_num)
    res = IntegralBF((n, a), (r, r_1_num, r_2_num)).doit()
    res = res.subs({a: a_num})
    res_num = res.evalf()

    def integrand(r, a, n):

        return FunctionBF(r, n, a).doit().evalf()
